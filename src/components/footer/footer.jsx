  ...
  return (
    <div className="w-full bg-[#4F46BA]">
      <div className="max-w-screen-2xl mx-auto">
        <div className="w-[90%] mx-auto bg-slateblue flex flex-row pt-20 flex-wrap  pb-20 items-start  justify-between text-lg text-white font-manrope ">
          ...
          <div className="flex gap-6">
            <div className="flex flex-col px-2.5 gap-4">
              ...
              <div className="flex flex-col gap-2 text-sm font-bold">
                <Link to="/howitworks" className="leading-6">
                  How it works
                </Link>
            ...
            <div className="flex flex-col px-2.5 gap-4">
              ...
              <div className="flex flex-col gap-2 text-sm text-gray-300">
                <Link className="leading-6" to="/aboutus">
                  About Us
                </Link>
                <Link className="leading-6" to="/contactus">
                  Contact
                </Link>
                {/* <Link className="leading-6" to="/billing">Billing</Link> */}
                <Link className="leading-6" to="/generate">
                  Generate
                </Link>
