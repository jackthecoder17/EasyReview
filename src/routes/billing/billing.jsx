  ...
  return (
    <>
      <div className="relative bg-white max-w-screen-2xl mx-auto h-auto">
        <Mainnav />
        <div className="w-[90%] mx-auto sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-28">
          {/* checkout */}
          <div className="w-full">
            ...
            <div className="w-full flex flex-col gap-3">
              ...
              <div className="w-full">
                <label htmlFor="companyName" className="opensans flex gap-3 text-[#333333] font-bold">
            ...
            {/* order summary */}
            <div className="w-full">
                <h3 className="opensans text-3xl font-bold mt-3 mb-5">Order Review</h3>
            </div>    
        </div>
      </div>
      <Footer />
